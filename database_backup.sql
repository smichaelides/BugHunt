...
--
-- Name: problems; Type: TABLE; Schema: public; Owner: lorenzocagliero
--
...
ALTER TABLE public.problems OWNER TO lorenzocagliero;

--
-- Name: problems_problemid_seq; Type: SEQUENCE; Schema: public; Owner: lorenzocagliero
--
...
ALTER TABLE public.problems_problemid_seq OWNER TO lorenzocagliero;

--
-- Name: problems_problemid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: lorenzocagliero
--
...
ALTER TABLE public.users OWNER TO lorenzocagliero;

--
-- Name: users_userid_seq; Type: SEQUENCE; Schema: public; Owner: lorenzocagliero
--
...
ALTER TABLE public.users_userid_seq OWNER TO lorenzocagliero;

--
-- Name: users_userid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: problems problemid; Type: DEFAULT; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: users userid; Type: DEFAULT; Schema: public; Owner: lorenzocagliero
--
...
--
-- Data for Name: problems; Type: TABLE DATA; Schema: public; Owner: lorenzocagliero
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: lorenzocagliero
--

COPY public.users (userid, username, email, streakcounter, points, challengescompleted, last_activity_date) FROM stdin;
1	Lorenzo Cagliero	lc2583@princeton.edu	1	80	8	2025-03-21
\.


--
-- Name: problems_problemid_seq; Type: SEQUENCE SET; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: users_userid_seq; Type: SEQUENCE SET; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: problems problems_pkey; Type: CONSTRAINT; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: public; Owner: lorenzocagliero
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: lorenzocagliero
--
